      ...
      <div className="grid grid-cols-1 md:grid-cols-[240px_1fr] gap-8">
        ...
        <div className="hidden md:block space-y-1">
          <div 
            ...
            className={`px-3 py-2 text-[13px] font-medium rounded-md flex items-center gap-2 cursor-pointer transition-colors ${activeTab === 'profile' ? 'bg-[#F4F4F5] text-[#18181B]' : 'text-[#71717A] hover:bg-[#F4F4F5] hover:text-[#18181B]'}`}
          >
            <UserIcon size={14} /> Profile Information
          </div>
          <div 
            onClick={() => setActiveTab('security')}
            className={`px-3 py-2 text-[13px] font-medium rounded-md flex items-center gap-2 cursor-pointer transition-colors ${activeTab === 'security' ? 'bg-[#F4F4F5] text-[#18181B]' : 'text-[#71717A] hover:bg-[#F4F4F5] hover:text-[#18181B]'}`}
          >
            <Shield size={14} /> Security & Password
          </div>
          <div 
            onClick={() => setActiveTab('preferences')}
            className={`px-3 py-2 text-[13px] font-medium rounded-md flex items-center gap-2 cursor-pointer transition-colors ${activeTab === 'preferences' ? 'bg-[#F4F4F5] text-[#18181B]' : 'text-[#71717A] hover:bg-[#F4F4F5] hover:text-[#18181B]'}`}
          >
        ...
        <div className="space-y-12">
          ...
          {activeTab === 'preferences' && (
            <section className="animate-fade-in">
              <div className="mb-5 pb-2" style={{ borderBottom: '1px solid rgba(0,0,0,0.06)' }}>
                <h2 className="text-[15px] font-semibold text-[#18181B] flex items-center gap-2">
                  <Bell size={16} className="md:hidden" /> System Preferences (Coming Soon!)
                </h2>
              </div>
